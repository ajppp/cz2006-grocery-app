...
class PurchasedListAdapter(private val context: Context,
                           private val userPurchasedItems: MutableList<Food>,
    ...
    RecyclerView.Adapter<PurchasedListAdapter.ViewHolder>() {
        ...
        inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
            ...
            fun bind(position: Int) {
                ...
                purchasedItemText.setOnCheckedChangeListener { _, isChecked ->
                    if (purchasedItemText.isChecked) {
                        itemClick(position)
                    }
                }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.purchased_item, parent, false)
